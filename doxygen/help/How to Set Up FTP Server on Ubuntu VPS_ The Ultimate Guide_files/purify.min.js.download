/*! @license DOMPurify 3.0.1 | (c) Cure53 and other contributors | Released under the Apache license 2.0 and Mozilla Public License 2.0 | github.com/cure53/DOMPurify/blob/3.0.1/LICENSE */ !(function (
  e,
  t,
) {
  ...
  var re = (function t() {
    ...
    var ye,
      ...
      dt = function (t) {
        (ft && ft === t) ||
          ...
          (t = L(t)),
          (ye = ye =
            -1 === ut.indexOf(t.PARSER_MEDIA_TYPE) ? st : t.PARSER_MEDIA_TYPE),
          (ge = 'application/xhtml+xml' === ye ? w : E),
          (_e = 'ALLOWED_TAGS' in t ? C({}, t.ALLOWED_TAGS, ge) : xe),
          (ke = 'ALLOWED_ATTR' in t ? C({}, t.ALLOWED_ATTR, ge) : Oe),
          (lt =
            'ALLOWED_\namespaceS' in t ? C({}, t.ALLOWED_\namespaceS, w) : ct),
          (et =
            'ADD_URI_SAFE_ATTR' in t ? C(L(tt), t.ADD_URI_SAFE_ATTR, ge) : tt),
          (Je =
            'ADD_DATA_URI_TAGS' in t ? C(L(Qe), t.ADD_DATA_URI_TAGS, ge) : Qe),
          ...
          t.FORBID_CONTENTS &&
            (Xe === Ze && (Xe = L(Xe)), C(Xe, t.FORBID_CONTENTS, ge)),
          $e && (_e['#text'] = !0),
    ...
    var Tt = function (e) {
        var t = ae(e);
        (t && t.tagName) || (t = { \namespaceURI: at, tagName: 'template' });
        var n = E(e.tagName),
          r = E(t.tagName);
        return (
          !!lt[e.\namespaceURI] &&
      ...
      kt = function (e) {
        ...
        if (!_e[n] || Re[n]) {
          if (!Re[n] && Dt(n)) {
            if (De.tagNameCheck instanceof RegExp && O(De.tagNameCheck, n))
              return !1;
        ...
        return e instanceof f && !Tt(e)
          ...
          : ('noscript' !== n && 'noembed' !== n) ||
            !O(/<\/no(script|embed)/i, e.innerHTML)
          ? (Fe &&
              3 === e.nodeType &&
              ((t = e.textContent),
              (t = _(t, be, ' ')),
              ...
              (t = _(t, Te, ' ')),
              e.textContent !== t &&
                (A(r.removed, { element: e.cloneNode() }),
                (e.textContent = t))),
      ...
      Ot = function (e, t, n) {
        if (We && ('id' === t || 'name' === t) && (n in i || n in mt))
          return !1;
        if (Me && !Ce[t] && O(Ne, t));
        else if (Le && O(Ae, t));
        else if (!ke[t] || Ce[t]) {
            ...
            if (
              ...
              if (Ue || !O(/\/>/i, o)) {
                ...
                if (Ot(m, a, o)) {
                  ...
                  try {
                    f ? t.setAttributeNS(f, s, o) : t.setAttribute(s, o),
                      N(r.removed);
                  } catch (e) {}
                }
              } else At(s, t);
      ...
      Ct = function e(t) {
        ...
        for (xt('beforeSanitizeShadowDOM', t, null); (n = r.nextNode()); )
          xt('uponSanitizeShadowNode', n, null),
            kt(n) || (n.content instanceof l && e(n.content), Rt(n));
    ...
    return (
      (r.sanitize = function (e) {
        ...
        if (
          ((it = !e) && (e = '\x3c!--\x3e'), 'string' != typeof e && !_t(e))
        ) {
        ...
        if (
          (He || dt(c), (r.removed = []), 'string' == typeof e && (Ke = !1), Ke)
        ) {
          if (e.nodeName) {
            var u = ge(e.nodeName);
            if (!_e[u] || Re[u])
          ...
          (1 ===
            (n = (t = Et('\x3c!----\x3e')).ownerDocument.importNode(e, !0))
              .nodeType &&
            'BODY' === n.nodeName) ||
          'HTML' === n.nodeName
            ? (t = n)
          ...
          if (!Pe && !Fe && !ze && -1 === e.indexOf('<'))
            return le && Ge ? le.createHTML(e) : e;
          if (!(t = Et(e))) return Pe ? null : Ge ? ce : '';
        }
        t && je && Nt(t.firstChild);
        for (var f = wt(Ke ? e : t); (a = f.nextNode()); )
          kt(a) || (a.content instanceof l && Ct(a.content), Rt(a));
        if (Ke) return e;
        if (Pe) {
          if (Be)
            for (i = me.call(t.ownerDocument); t.firstChild; )
              i.appendChild(t.firstChild);
          else i = t;
          return (
            (ke.shadowroot || ke.shadowrootmod) && (i = de.call(o, i, !0)), i
          );
        }
        ...
        return (
          ze &&
            ...
            O(ee, t.ownerDocument.doctype.name) &&
